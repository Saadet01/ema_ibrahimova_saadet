...
class Grammar13Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_grammar13)

        imageSound01=findViewById(R.id.grammar13_sentence01_sound)
        imageSound02=findViewById(R.id.grammar13_sentence02_sound)
        imageSound03=findViewById(R.id.grammar13_sentence03_sound)
        imageSound04=findViewById(R.id.grammar13_sentence04_sound)
        textSentence01Ger=findViewById(R.id.grammar13_sentence01_ger)
        textSentence02Ger=findViewById(R.id.grammar13_sentence02_ger)
        textSentence03Ger=findViewById(R.id.grammar13_sentence03_ger)
        textSentence04Ger=findViewById(R.id.grammar13_sentence04_ger)
