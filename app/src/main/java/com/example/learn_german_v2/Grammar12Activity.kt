...
class Grammar12Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_grammar12)

        imageSound01=findViewById(R.id.grammar12_sentence01_sound)
        imageSound02=findViewById(R.id.grammar12_sentence02_sound)
        imageSound03=findViewById(R.id.grammar12_sentence03_sound)
        imageSound04=findViewById(R.id.grammar12_sentence04_sound)
        textSentence01Ger=findViewById(R.id.grammar12_sentence01_ger)
        textSentence02Ger=findViewById(R.id.grammar12_sentence02_ger)
        textSentence03Ger=findViewById(R.id.grammar12_sentence03_ger)
        textSentence04Ger=findViewById(R.id.grammar12_sentence04_ger)
